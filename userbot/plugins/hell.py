...
if ALIVE_PIC is None:
   ALIVE_PIC = "https://telegra.ph/file/3783bd9bdde374797c704.jpg"
...
if ALIVE_MESSAGE is None:
   ALIVE_MESSAGE = "**🔱ABUserbot Is Alive🔱 \n\n\n**"
   ...
   ALIVE_MESSAGE += f"Support Channel : @AyushBots \n\n"
